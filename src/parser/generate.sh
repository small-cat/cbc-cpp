...
java -Xmx500M -cp /home/jona/software/antlr4/antlr-4.7.1-complete.jar org.antlr.v4.Tool -Dlanguage=Cpp -listener -visitor -Werror -o generated/ -package parser SesameLexer.g4 SesameParser.g4

sed -i 's/;;/;/g' generated/SesameParser.h
